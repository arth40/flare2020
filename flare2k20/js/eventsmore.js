...
function d2nz(){
	confirm("Pdpu brings to you the national solo and duet dance competition. We have been having numerous students from various colleges participating for this dance competition, as it is a wonderful platform to showcase different forms. It is a great opportunity for those who have a passion for dance and definitely an opportunity not worth missing!");
}
...
function d2atmo(){
	confirm("At-Mosh-Sphere is a nationwide battle of bands hosted by Offbeat – The Music Club of Pandit Deendayal Petroleum University where we invite bands from all over India to perform, compete and hence, grow. Members of a headlining band judge the performances and declare the winner. The Bands can perform either a composition of their own or a cover and win exciting prizes.");
}
...
function d3ms(){
	confirm("Following their landmark “Love Yourself” tour, BTS triumphantly returns to cinema screens in BRING THE SOUL: THE MOVIE. A glimpse into BTS’ world away from the stage, featuring intimate group discussions alongside spectacular concert performances from the tour, this cinema event not to be missed. The journey of BTS continues!");
}
